...
//        adminService = new AdminServiceImpl(userRepository, userDetailsRepository, passwordEncoder, roleRepository);
...
//        adminService.saveUserAdmin(UserTransformer.transform(mockUser));
